...
Version  : 47.2
Release  : 77
URL      : https://download.gnome.org/sources/orca/47/orca-47.2.tar.xz
Source0  : https://download.gnome.org/sources/orca/47/orca-47.2.tar.xz
...
%prep
%setup -q -n orca-47.2
cd %{_builddir}/orca-47.2
pushd ..
cp -a orca-47.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732303387
