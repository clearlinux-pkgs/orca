...
Version  : 46.0
Release  : 70
URL      : https://download.gnome.org/sources/orca/46/orca-46.0.tar.xz
Source0  : https://download.gnome.org/sources/orca/46/orca-46.0.tar.xz
...
%prep
%setup -q -n orca-46.0
cd %{_builddir}/orca-46.0
pushd ..
cp -a orca-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710955663
