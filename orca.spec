...
Version  : 45.1
Release  : 68
URL      : https://download.gnome.org/sources/orca/45/orca-45.1.tar.xz
Source0  : https://download.gnome.org/sources/orca/45/orca-45.1.tar.xz
...
%prep
%setup -q -n orca-45.1
cd %{_builddir}/orca-45.1
pushd ..
cp -a orca-45.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697839459
