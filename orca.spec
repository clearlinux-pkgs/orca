...
Version  : 3.30.1
Release  : 13
URL      : https://download.gnome.org/sources/orca/3.30/orca-3.30.1.tar.xz
Source0  : https://download.gnome.org/sources/orca/3.30/orca-3.30.1.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1539945883
