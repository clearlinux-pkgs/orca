...
%prep
%setup -q -n orca-3.34.1
cd %{_builddir}/orca-3.34.1
...
cp %{_builddir}/orca-3.34.1/icons/COPYING %{buildroot}/usr/share/package-licenses/orca/a1b087217d26810acdf85a9db199e8f3605b743a
%make_install
%find_lang orca
