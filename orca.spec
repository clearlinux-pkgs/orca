...
Source0  : https://download.gnome.org/sources/orca/3.28/orca-3.28.2.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : LGPL-2.1
Requires: orca-bin
Requires: orca-python3
Requires: orca-license
Requires: orca-data
Requires: orca-locales
Requires: orca-man
Requires: orca-python
...
export LANG=C
export SOURCE_DATE_EPOCH=1530283960
...
export SOURCE_DATE_EPOCH=1530283960
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/orca
cp COPYING %{buildroot}/usr/share/doc/orca/COPYING
cp icons/COPYING %{buildroot}/usr/share/doc/orca/icons_COPYING
%make_install
%find_lang orca
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/orca/COPYING
/usr/share/doc/orca/icons_COPYING
