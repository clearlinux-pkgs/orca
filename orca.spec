...
Version  : 41.2
Release  : 50
URL      : https://download.gnome.org/sources/orca/41/orca-41.2.tar.xz
Source0  : https://download.gnome.org/sources/orca/41/orca-41.2.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643665660
...
cp %{_builddir}/orca-41.2/COPYING %{buildroot}/usr/share/package-licenses/orca/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/orca-41.2/icons/COPYING %{buildroot}/usr/share/package-licenses/orca/a1b087217d26810acdf85a9db199e8f3605b743a
%make_install
%find_lang orca
