...
Version  : 3.30.2
Release  : 15
URL      : https://download.gnome.org/sources/orca/3.30/orca-3.30.2.tar.xz
Source0  : https://download.gnome.org/sources/orca/3.30/orca-3.30.2.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1549122892
