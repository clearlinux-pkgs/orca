...
Version  : 45.2
Release  : 74
URL      : https://download.gnome.org/sources/orca/45/orca-45.2.tar.xz
Source0  : https://download.gnome.org/sources/orca/45/orca-45.2.tar.xz
...
%prep
%setup -q -n orca-45.2
cd %{_builddir}/orca-45.2
pushd ..
cp -a orca-45.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728611359
