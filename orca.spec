...
Version  : 40.0
Release  : 42
URL      : https://download.gnome.org/sources/orca/40/orca-40.0.tar.xz
Source0  : https://download.gnome.org/sources/orca/40/orca-40.0.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619118993
...
cp %{_builddir}/orca-40.0/COPYING %{buildroot}/usr/share/package-licenses/orca/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/orca-40.0/icons/COPYING %{buildroot}/usr/share/package-licenses/orca/a1b087217d26810acdf85a9db199e8f3605b743a
%make_install
%find_lang orca
