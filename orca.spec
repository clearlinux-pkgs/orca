...
%prep
%setup -q -n orca-3.38.1
cd %{_builddir}/orca-3.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607486875
...
cp %{_builddir}/orca-3.38.1/COPYING %{buildroot}/usr/share/package-licenses/orca/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/orca-3.38.1/icons/COPYING %{buildroot}/usr/share/package-licenses/orca/a1b087217d26810acdf85a9db199e8f3605b743a
%make_install
%find_lang orca
