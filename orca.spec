...
Version  : 48.1
Release  : 80
URL      : https://download.gnome.org/sources/orca/48/orca-48.1.tar.xz
Source0  : https://download.gnome.org/sources/orca/48/orca-48.1.tar.xz
...
%prep
%setup -q -n orca-48.1
cd %{_builddir}/orca-48.1
pushd ..
cp -a orca-48.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748361891
